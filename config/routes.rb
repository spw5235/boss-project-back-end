...
Rails.application.routes.draw do
  ...
  get '/students/:student_id/settings/:setting_id/observations' => 'observations#index'
  post '/students/:student_id/settings/:setting_id/observations' => 'observations#create'
